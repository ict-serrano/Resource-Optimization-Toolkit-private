        ...
        stage('Deploy in INTRA Kubernetes') {
            ...
            steps {
                container('helm') {
                    ...
                    sh "kubectl logos serrano-rot-controller-5fd54fb87-kkqwp --namespace integration"
                    sh "kubectl describe pod serrano-rot-engine-7b756bb4f5-n2xfp --namespace integration"
                    sh "kubectl logos serrano-rot-engine-7b756bb4f5-n2xfp --namespace integration"
