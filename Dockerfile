...
RUN apt-get update && apt-get install -y python3-pip libglib2.0-0 net-tools iputils-ping
...
RUN chmod 666 /home/serrano/.rot/engine.json
RUN chmod -R 777 /home/serrano/serrano_rot
USER serrano